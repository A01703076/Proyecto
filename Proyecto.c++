//Mi proyecto es un codigo que da el tipo de cambio a tres monedas, dolar, euro y libra, dando una cantidad en pesos mexicanos //
...
int main (){
    float dinero, presio;
    cout<<"\nIngrese su cantidad de dinero en pesos mexicanos : "; cin >> dinero;
